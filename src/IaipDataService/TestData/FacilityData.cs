    ...
    [
        new("00100001")
        {
            ...
            RegulatoryData = new RegulatoryData
            {
                ...
                Pollutants = new Dictionary<string, string>
                {
                    ...
                    { "10461", "Sulfur Dioxide" },
                    { "300000005", "Nitrogen Dioxide" },
                    { "300000236", "Visible Emissions" },
                    { "300000242", "Total HAP" },
                    { "300000243", "Volatile Organic Compounds" },
                    { "300000301", "Fugitive Dust" },
                    { "300000302", "Fugitive Emissions" },
                    { "300000319", "Particulate Matter < 10 um" },
                    { "300000322", "Total Particulate Matter" },
                    { "300000328", "Administration" },
                    { "300000329", "Facility Wide" },
                    { "300000330", "Other Emissions Other than road based" },
                },
                AirPrograms = [AirProgram.SIP, AirProgram.MACT],
                ProgramClassifications = [AirProgramClassifications.NsrMajor],
        ...
        new("05100149")
        {
            ...
            RegulatoryData = new RegulatoryData
            {
                ...
                ProgramClassifications = [AirProgramClassifications.HapMajor],
                OneHourOzoneNonattainment = OneHourOzoneNonattainmentStatus.No,
                EightHourOzoneNonattainment = EightHourOzoneNonattainmentStatus.None,
                PmFineNonattainment = PmFineNonattainmentStatus.None,
            },
