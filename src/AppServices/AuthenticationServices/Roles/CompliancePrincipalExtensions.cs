...
public static class CompliancePrincipalExtensions
{
    ...
    extension(IPrincipal principal)
    {
        ...
        internal bool IsComplianceManager() => principal.IsInRole(RoleName.ComplianceManager);

        internal bool IsComplianceSiteMaintainer() => principal.IsInRole(RoleName.ComplianceSiteMaintenance);
