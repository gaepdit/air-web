...
internal static class WorkEntryFilters
{
    ...
    private static Expression<Func<BaseWorkEntry, bool>> ByDeletedStatus(
    ...
    private static Expression<Func<BaseWorkEntry, bool>> FromClosedDate(
        this Expression<Func<BaseWorkEntry, bool>> predicate,
        DateOnly? input) =>
        input is null
            ? predicate
    ...
    private static Expression<Func<BaseWorkEntry, bool>> ContainsText(
        this Expression<Func<BaseWorkEntry, bool>> predicate,
        string? input) =>
