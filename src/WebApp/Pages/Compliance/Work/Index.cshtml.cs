    ...
    : PageModel
{
    ...
    public bool UserCanViewDeletedWorkEntries { get; private set; }
    public IPaginatedResult<WorkEntrySearchResultDto> SearchResults { get; private set; } = default!;
    public SearchResultsDisplay ResultsDisplay => new(Spec, SearchResults);
    ...
    public async Task OnGetAsync()
    {
        ...
        //TODO: FIX THIS!
        UserCanViewDeletedWorkEntries = await authorization.Succeeded(User, Policies.Manager);
