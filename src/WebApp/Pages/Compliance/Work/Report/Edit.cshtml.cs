...
public class EditModel(
    ...
    IValidator<ReportUpdateDto> validator) : PageModel
{
    [FromRoute]
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        var item = (ReportUpdateDto?)await entryService.FindForUpdateAsync(Id);
    ...
    {
        var original = (ReportUpdateDto?)await entryService.FindForUpdateAsync(Id, token);
        ...
        const WorkEntryType entryType = WorkEntryType.Report;
