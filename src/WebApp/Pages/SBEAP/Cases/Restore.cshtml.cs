    ...
    : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(Guid? id)
    {
        ...
        if (!item.IsDeleted)
        {
            TempData.AddDisplayMessage(DisplayMessage.AlertContext.Info, "Case is not deleted.");
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        TempData.AddDisplayMessage(DisplayMessage.AlertContext.Success, "Case successfully restored.");
        return RedirectToPage("Details", new { Id });
    }
