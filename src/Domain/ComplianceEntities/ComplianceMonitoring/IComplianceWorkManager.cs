...
public interface IComplianceWorkManager : IDisposable, IAsyncDisposable
{
    ...
    /// </summary>
    /// <param name="type">The <see cref="ComplianceWorkType"/> of the ComplianceWork to create.</param>
    /// <param name="facilityId">The ID of the facility associated with the ComplianceWork.</param>
    /// <param name="user">The user creating the entity.</param>
    /// <returns>The ComplianceWork that was created.</returns>
    ...
    /// </summary>
    /// <param name="complianceWork">The entry that was deleted.</param>
    ...
    /// </summary>
    /// <param name="complianceWork">The entry that was restored.</param>
