...
public interface IComplianceSearchRepository<TEntity> : IDisposable, IAsyncDisposable
    where TEntity : class, IEntity<int>, IComplianceEntity
{
    ...
    Task<IReadOnlyCollection<TEntity>> GetFilteredRecordsAsync(Expression<Func<TEntity, bool>> expression,
    ...
    public Task<int> CountRecordsAsync(Expression<Func<TEntity, bool>> expression,
