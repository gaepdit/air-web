...
public static class CountyLocationData
{
    ...
    [
        ...
        new(Name: "Chattahoochee County", Location: "32.3778463,-84.987519,11z"),
        new(Name: "Chattooga County", Location: "34.4377299,-85.4823138,11z"),
        new(Name: "Cherokee County", Location: "34.2429542,-84.6232228,11z"),
        new(Name: "Clarke County", Location: "33.9645891,-83.4466999,12z"),
        new(Name: "Clay County", Location: "31.6330612,-85.1349417,11z"),
        new(Name: "Clayton County", Location: "33.5005609,-84.5160709,11z"),
        new(Name: "Clinch County", Location: "30.8826422,-83.0246337,10z"),
        new(Name: "Cobb County", Location: "33.9126212,-84.7219818,11z"),
        new(Name: "Coffee County", Location: "31.5896183,-83.2033612,10z"),
        new(Name: "Colquitt County", Location: "31.180308,-83.9244318,11z"),
        new(Name: "Columbia County", Location: "33.5275305,-82.4003515,11z"),
        new(Name: "Cook County", Location: "31.188713,-83.5932002,11z"),
        new(Name: "Coweta County", Location: "33.3512577,-84.9210099,11z"),
        new(Name: "Crawford County", Location: "32.6934243,-84.1166685,11z"),
        new(Name: "Crisp County", Location: "31.9169397,-83.9502057,11z"),
    ];
}
