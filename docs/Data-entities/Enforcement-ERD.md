...
| DATLONTOUC                 | datetime2(0)  |    ✓    |                           | (LON) Notes, (LON) CreatedAt                 |
...
| DATNOVTOUC                 | datetime2(0)  |    ✓    |                           | (NOV, NOVNFA) Notes, (NOV, NOVNFA) CreatedAt |
...
| DATNFATOUC                 | datetime2(0)  |    ✓    |                           | (NFA) Notes, (NFA) CreatedAt                 |
...
| STRCOTOUC                  | varchar(5)    |    ✗    |                           |                                              |
| DATCOTOUC                  | datetime2(0)  |    ✓    |                           | (PCO) Notes, (PCO) CreatedAt                 |
| STRCOTOPM                  | varchar(5)    |    ✗    |                           |                                              |
...
| DATCORECEIVEDFROMCOMPANY   | datetime2(0)  |    ✓    |                           | ReceivedFromFacility, (CO) CreatedAt         |
